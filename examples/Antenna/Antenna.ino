...
if (!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) { // Address 0x3D for 128x64 ZMIANA NA 0x3D !!!!!!
  ...
  compressor.clear();
  compressor.format = "0_8_SendNum_0_255_0_0 8_34_Latitude_49.0000000_54.5000000_2_7 34_61_Longitude_14.0699997_24.0900002_2_7 61_75_Altitude_0.0_1000.0_4_1 75_98_Pressure_600.0000_1200.0000_4_4 98_111_Temperature_-20.00_50.00_2_2 111_125_AirQuality_0.0_1024.0_4_1 125_135_PM25_0.0_100.0_3_1 135_145_PM100_0.0_100.0_3_1 145_155_Humidity_0.0_100.0_3_1 155_165_Battery_0_1024_4_0 ";
//OLED
...
void loop() {
  ...
  SerialUSB.println(String(rssi) + "_" +
                    String((int)compressor.retrieve("SendNum").value) + "_" + 
                    ...
                    String((int)compressor.retrieve("AirQuality").value) + "_" +
                    String(compressor.retrieve("PM25").value, compressor.retrieve("PM25").decimals) + "_" +
                    String(compressor.retrieve("PM100").value, compressor.retrieve("PM100").decimals) + "_" +
                    String(compressor.retrieve("Humidity").value, compressor.retrieve("Humidity").decimals) + "_" +
                    String((int)compressor.retrieve("Battery").value));
  ...
  display.print("Packs: ");
  display.println(String(package_num) + " " + String((int)compressor.retrieve("SendNum").value));
